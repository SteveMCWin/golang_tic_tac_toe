...
## Features
- Login portals (Google and Github) based on the [goth package](https://github.com/markbates/goth)
- Websocket implementation allowing multiplayer based on the [gorilla websocket package.](https://github.com/gorilla/websocket)
